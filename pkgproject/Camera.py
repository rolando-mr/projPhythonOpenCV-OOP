...
class Camera:
    ...
    configure_raspi_camera() -> si se usa una raspberry pi camera
    configure_web_camera() -> si usa una webcam
    """
    ...
    def configure_raspi_camera(self):
